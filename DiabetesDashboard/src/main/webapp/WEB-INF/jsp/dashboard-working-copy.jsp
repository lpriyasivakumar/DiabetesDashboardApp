	...
	<section id="container" class="">
		...
		<section class="a1c-form">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form method="post" action="a1c" role="entry" id="a1cEntryform">
						<div class="form-group">
							<label for="labA1c">Lab A1c Value</label>
							<input type="text" name="labA1c" id="labA1c" class="form-control input" maxlength="4" value="${labA1c}"/>
							<div class="form-group col-lg-offset-2 col-lg-9">
								<button type="submit" class="btn btn-info btn-block" name="action" value="saveLabValue">Save Lab A1c</button>
							</div>
						</div>
						<div class="form-group">
							<!--  	<input type="hidden" name="action" value="add"> -->
							<label for="estimatedA1c">Estimated A1c Value<span>*</span></label>
							<input type="text" name="estimatedA1c" id="estimatedA1c" class="form-control input" maxlength="4"/>
							<div class="form-group col-lg-offset-2 col-lg-9">
								<button type="submit" class="btn btn-info btn-block" name="action" value="CalcA1c">Calculate Estimated A1c</button>
							</div>
						</div>
					</form>
				</div>
					...
					<div class="row row-centered">
						<div class="col-lg-9 col-md-12">
							<form action="dashboard" method="get" role="select" id="TrendEntryForm">
								<div class="form-group">
